...
class Post(models.Model):
    serial_num = models.CharField(max_length=10, default=None) #流水號
    ...
    teacher = models.CharField(max_length=25, default=None) #授課教師
    add_type = models.PositiveIntegerField(default=None) #加選方式
    class_time = models.CharField(max_length=150, default=None) #上課時間
    place = models.CharField(max_length=40, default=None) #上課地點
    stu_number = models.CharField(max_length=50, default=None)#總人數
    click_times = models.IntegerField(default=0) #點擊次數
    constraints = models.CharField(max_length=300, default=None)#選課限制條件
    ...
    def __str__(self):
        return '{} {}'.format(self.teacher, self.class_name)
